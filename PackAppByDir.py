...
class CreateBundle(object):
    ...
    def cp_all_folders(self):
        ...
        cmd = r'cp ./dist/main "{}/Contents/Resources"'.format(self._app_path)
        os.system(cmd)
...
if __name__ == '__main__':
    cmd = 'cd {} & Pyinstaller -F -w {}/main.py'.format(os.path.dirname(os.path.abspath(__file__)),os.path.dirname(os.path.abspath(__file__)))
    os.system(cmd)
    bundle = CreateBundle('H28_FWDL', '0.0.01', 'main')
